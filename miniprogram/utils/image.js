const DEFAULT_PRODUCT_IMAGE = '/assets/tabbar/home.png'
...
function normalizeImageMeta(url, type) {
  ...
  if (value.indexOf('http://') === 0 && value.indexOf('tcloudbase.com/uploads/') >= 0) {
    return { url: `https://${value.slice('http://'.length)}`, legacy: true }
  }
